...
/**
 * Session-based auth (the plan's "simpler for a first cut" choice): the browser holds a session
 * cookie after POST /api/auth/login, and every other request (including the /ws handshake) rides
...
public class SecurityConfig {
    ...
    @Bean
    public DaoAuthenticationProvider authenticationProvider(ChatRelayUserDetailsService userDetailsService,
